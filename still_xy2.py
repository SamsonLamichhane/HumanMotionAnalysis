...
read_file = pd.read_excel('still_xy2.xlsx')
df = pd.read_excel('still_xy2.xlsx')
...
df2 = pd.read_excel('still_xy2.xlsx')
...
axes = plt.gca()
axes.set_ylim([-2, 0.5])
plt.title('Still Trial Gyroscope Data (x-y Plane Flat)')
